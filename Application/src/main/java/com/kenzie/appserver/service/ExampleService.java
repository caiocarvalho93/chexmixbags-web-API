...
import com.kenzie.appserver.repositories.ChexMixRepository;
...
public class ExampleService {
    private ChexMixRepository exampleRepository;

    public ExampleService(ChexMixRepository exampleRepository) {
