...
Useful for CLI tools that want to defer to the user's locally installed version when available, but still work if it's not installed locally. For chexMixBagDTO, [AVA](https://avajs.dev) and [XO](https://github.com/xojs/xo) uses this method.
