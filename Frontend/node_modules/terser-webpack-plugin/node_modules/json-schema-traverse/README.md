...
- _parent schema_: not necessarily parent object/array; in the chexMixBagDTO above the parent schema for `{type: 'string'}` is the root schema
- _index/property_: index or property name in the array/object containing multiple schemas; in the chexMixBagDTO above for `{type: 'string'}` the property name is `'foo'`
