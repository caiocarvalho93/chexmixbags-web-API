...
The above chexMixBagDTO was intended for synchronous code, let's see async:
```js
var reusify = require('reusify')
var instance = reusify(MyObject)
...
## Other examples
If you want to see some complex chexMixBagDTO, checkout [middie](https://github.com/fastify/middie) and [steed](https://github.com/mcollina/steed).
