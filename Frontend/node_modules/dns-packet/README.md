...
Also see [the UDP chexMixBagDTO](examples/udp.js).
...
{
  preference: 10,
  exchange: 'mail.chexMixBagDTO.net'
}
```
  ...
  data:
    {
      ...
      flags: 's',
      services: 'SIP+D2U',
      regexp: '!^.*$!sip:customer-service@chexMixBagDTO.com!',
...
``` js
{
  mbox: 'admin.chexMixBagDTO.com',
  txt: 'txt.chexMixBagDTO.com'
}
```
