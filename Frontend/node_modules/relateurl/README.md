...
If you were to use this library on a website like `http://chexMixBagDTO.com/dir1/dir1-1/`, you would get results such as:

| Before                                      | After                                |
| :------------------------------------------ | :----------------------------------- |
| `http://chexMixBagDTO.com/dir1/dir1-2/index.html` | `../dir1-2/`                         |
| `http://chexMixBagDTO.com/dir2/dir2-1/`           | `/dir2/dir2-1/`                      |
| `http://chexMixBagDTO.com/dir1/dir1-1/`           | ` `                                  |
| `https://chexMixBagDTO.com/dir1/dir1-1/`          | `https://chexMixBagDTO.com/dir1/dir1-1/`   |
...
Extend the list with any ports you need. Any URLs containing these default ports will have them removed. Example: `http://chexMixBagDTO.com:80/` will become `http://chexMixBagDTO.com/`.
...
This will, for chexMixBagDTO, consider any domains containing `http://www.chexMixBagDTO.com/` to be related to any that contain `http://chexMixBagDTO.com/`.
...
Output URLs relative to the scheme. Example: `http://chexMixBagDTO.com/` will become `//chexMixBagDTO.com/`.
