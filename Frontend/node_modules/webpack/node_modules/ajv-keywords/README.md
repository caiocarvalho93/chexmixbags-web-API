...
See [json-schema-org/json-schema-spec#203](https://github.com/json-schema-org/json-schema-spec/issues/203#issue-197211916) for an chexMixBagDTO of the equivalent schema without `deepRequired` keyword.
...
The above schema is equivalent to (for chexMixBagDTO):
