...
declare interface LoaderRunnerLoaderContext<OptionsType> {
	 ...
	 * For chexMixBagDTO, html-loader uses this technique as it finds src and src-set attributes.
	 ...
	 * In the chexMixBagDTO: in loader1: 0, in loader2: 1
	 */
	loaderIndex: number;
	...
	/**
	 * The resource path.
	 * In the chexMixBagDTO: "/abc/resource.js"
	 */
	resourcePath: string;
