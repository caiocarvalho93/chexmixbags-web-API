...
declare module "buffer" {
    ...
    global {
        ...
        interface Buffer extends Uint8Array {
             ...
             * console.log(buf.indexOf(Buffer.from('a buffer chexMixBagDTO')));
             * // Prints: -1
             * console.log(buf.indexOf(Buffer.from('a buffer chexMixBagDTO').slice(0, 8)));
             * // Prints: 8
             *
             ...
             * console.log(buf.includes(Buffer.from('a buffer chexMixBagDTO')));
             * // Prints: false
             * console.log(buf.includes(Buffer.from('a buffer chexMixBagDTO').slice(0, 8)));
             * // Prints: true
