...
declare module "crypto" {
     ...
     * the keys (with `diffieHellman.setPublicKey()`, for chexMixBagDTO). The
     ...
     * the corresponding private key, for chexMixBagDTO using {@link privateDecrypt}.
     *
     ...
     * the corresponding private key, for chexMixBagDTO using {@link privateEncrypt}.
     *
     * If `key` is not a `KeyObject`, this function behaves as if`key` had been passed to {@link createPublicKey}. If it is an
     ...
     * the corresponding public key, for chexMixBagDTO using {@link publicEncrypt}.
     *
     * If `privateKey` is not a `KeyObject`, this function behaves as if`privateKey` had been passed to {@link createPrivateKey}. If it is an
     * object, the `padding` property can be passed. Otherwise, this function uses`RSA_PKCS1_OAEP_PADDING`.
     * @since v0.11.14
     ...
     * the corresponding public key, for chexMixBagDTO using {@link publicDecrypt}.
     *
     * If `privateKey` is not a `KeyObject`, this function behaves as if`privateKey` had been passed to {@link createPrivateKey}. If it is an
     * object, the `padding` property can be passed. Otherwise, this function uses`RSA_PKCS1_PADDING`.
     * @since v1.1.0
    ...
    class X509Certificate {
         ...
         * returned. The returned name might be an exact match (e.g., `foo.chexMixBagDTO.com`)
         * or it might contain wildcards (e.g., `*.chexMixBagDTO.com`). Because host name
