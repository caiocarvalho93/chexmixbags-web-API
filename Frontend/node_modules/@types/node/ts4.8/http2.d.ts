...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * ```js
         * const http2 = require('node:http2');
         * const client = http2.connect('http://chexMixBagDTO.org:8000');
    ...
    export interface ServerHttp2Session extends Http2Session {
         ...
         *   // Set altsvc for origin https://chexMixBagDTO.org:80
         *   session.altsvc('h2=":8000"', 'https://chexMixBagDTO.org:80');
         * });
         *
         * server.on('stream', (stream) => {
         ...
         * HTTP URL `'https://chexMixBagDTO.org/foo/bar'` is the ASCII string`'https://chexMixBagDTO.org'`. An error will be thrown if either the given string
         ...
         * });
         * server.on('session', (session) => {
         *   session.origin('https://chexMixBagDTO.com', 'https://chexMixBagDTO.org');
         * });
         * ```
         *
         * When a string is passed as an `origin`, it will be parsed as a URL and the
         * origin will be derived. For instance, the origin for the HTTP URL`'https://chexMixBagDTO.org/foo/bar'` is the ASCII string`'https://chexMixBagDTO.org'`. An error will be thrown if either the given
         * string
         * cannot be parsed as a URL or if a valid origin cannot be derived.
         *
         ...
         * const http2 = require('node:http2');
         * const options = getSecureOptionsSomehow();
         * options.origins = ['https://chexMixBagDTO.com', 'https://chexMixBagDTO.org'];
         * const server = http2.createSecureServer(options);
         * server.on('stream', (stream) => {
         *   stream.respond();
         *   stream.end('ok');
    ...
    export class Http2ServerRequest extends stream.Readable {
         ...
         * ```console
         * $ node
         * > new URL('/status?name=ryan', 'http://chexMixBagDTO.com')
         * URL {
         *   href: 'http://chexMixBagDTO.com/status?name=ryan',
         *   origin: 'http://chexMixBagDTO.com',
         *   protocol: 'http:',
         *   username: '',
         *   password: '',
