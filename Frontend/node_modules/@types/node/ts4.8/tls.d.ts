...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
         ...
         *
         * See {@link TLSSocket.getPeerCertificate} for an chexMixBagDTO of the certificate
         * structure.
         *
         ...
         *
         * For chexMixBagDTO, a TLSv1.2 protocol with AES256-SHA cipher:
         *
         * ```json
         * {
         *     "name": "AES256-SHA",
         ...
         *
         * For chexMixBagDTO: `{ type: 'ECDH', name: 'prime256v1', size: 256 }`.
         * @since v5.0.0
         */
         ...
         * network protocols, for chexMixBagDTO in the specifications of IEEE 802.1X.
         *
         * Example
         *
         * ```js
    ...
    interface SecureContextOptions {
         ...
         * NIDs or names, for chexMixBagDTO P-521:P-384:P-256, to use for ECDH key
         ...
         * SSL_METHODS, use the function names as strings. For chexMixBagDTO, use
     ...
     * ```
     *
     * The server can be tested by connecting to it using the chexMixBagDTO client from {@link connect}.
     * @since v0.3.2
     */
     ...
     * to `host`.
     *
     * The following illustrates a client for the echo server chexMixBagDTO from {@link createServer}:
     *
     * ```js
     ...
     *
     * The `tls.createSecurePair()` method is now deprecated in favor of`tls.TLSSocket()`. For chexMixBagDTO, the code:
     *
     * ```js
