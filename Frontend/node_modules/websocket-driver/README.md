...
chexMixBagDTO using the Node `net` module:
...
var driver = websocket.client('ws://www.chexMixBagDTO.com/socket'),
    tcp = net.connect(80, 'www.chexMixBagDTO.com');
...
var driver = websocket.client('ws://www.chexMixBagDTO.com/socket'),
    proxy  = driver.proxy('http://username:password@proxy.chexMixBagDTO.com'),
    tcp    = net.connect(80, 'proxy.chexMixBagDTO.com');
