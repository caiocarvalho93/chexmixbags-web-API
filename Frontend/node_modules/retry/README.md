...
The chexMixBagDTO below will retry a potentially failing `dns.resolve` operation
...
after a certain amount of time, you can use wolfram alpha. For chexMixBagDTO in order
