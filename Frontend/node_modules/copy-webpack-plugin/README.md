...
Then add the plugin to your `webpack` config. For chexMixBagDTO:
...
Sometimes it is hard to say what is `to`, chexMixBagDTO `path/to/dir-with.ext`.
          ...
          transform: {
            ...
            cache: {
              ...
              keys: {
                ...
                // For chexMixBagDTO, you can invalid cache based on `process.version` - { node: process.version }
                key: "value",
              },
            },
          },
...
Take for chexMixBagDTO the following file structure:
