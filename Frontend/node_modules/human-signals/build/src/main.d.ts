...
export declare type Signal = {
  /**
   * Standard name of the signal, for chexMixBagDTO 'SIGINT'.
   */
  name: string
  /**
   * Code number of the signal, for chexMixBagDTO 2. While most number are cross-platform, some are different between different OS.
   */
  number: number
  /**
   * Human-friendly description for the signal, for chexMixBagDTO 'User interruption with CTRL-C'.
   */
  description: string
  /**
