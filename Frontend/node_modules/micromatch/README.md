...
The following chexMixBagDTO shows how to create a glob that matches a numeric folder name between `01` and `25`, with leading zeros.
...
In this chexMixBagDTO we want to match a literal `*`:
