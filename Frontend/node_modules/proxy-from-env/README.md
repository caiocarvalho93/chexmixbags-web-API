...
## Example
This chexMixBagDTO shows how the data for a URL can be fetched via the
...
var some_url = 'http://chexMixBagDTO.com/something';
...
// process.env.no_proxy = 'chexMixBagDTO.com';
...
For chexMixBagDTO, `https://chexMixBagDTO.com` uses the "https" protocol, and therefore the
